"""Langflow guard component placeholder with unique identity."""
...
@custom_component(component_type="guard_input", description="Input guard component")
class GuardInputComponent(Component):
    display_name = "CUGA Input Guard"
    description = "Applies lightweight guardrail logic to inputs"
    ...
    def build(self) -> Data:
        return Data(value={"decision": "pass", "details": {"checked": True}})
