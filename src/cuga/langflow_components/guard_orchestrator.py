...
@custom_component(component_type="guard_orchestrator", description="Orchestrates guard stages")
class GuardOrchestratorComponent(Component):
    display_name = "CUGA Guard Orchestrator"
    description = "Routes payloads through configured guard stages"
    ...
    def build(self) -> Data:
        return Data(value={"decision": "pass", "details": {"stages": 3}})
