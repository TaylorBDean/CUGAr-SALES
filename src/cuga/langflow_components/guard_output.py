"""Langflow output guard component with unique identity."""
...
@custom_component(component_type="guard_output", description="Output guard component")
class GuardOutputComponent(Component):
    display_name = "CUGA Output Guard"
    description = "Applies lightweight guardrail logic to outputs"
    ...
    def build(self) -> Data:
        return Data(value={"decision": "pass", "details": {"length": 0}})
